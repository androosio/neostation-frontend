  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        // One shared backdrop snapshot for every NeoGlass panel on this screen
        // (list panel, action rail, tab pill, footer pills). Without the group
        // each panel's blur pass re-reads the whole scene, so the cost scales
        // with the number of glass surfaces rather than with their area.
        body: BackdropGroup(
          child: Stack(
            children: [
