...
/// Tests for migration v137, which adds the collections browser's own sort
...
void main() {
  ...
  Future<void> runV137() => SqliteMigrations.migrateToVersion(db, 137);
