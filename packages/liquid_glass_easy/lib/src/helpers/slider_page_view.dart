              ...
              children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: SegmentedButton<LiquidGlassCornerStyle>(
                              segments: const [
                                ButtonSegment(
                                  value:
                ...
                _buildSliderPage(
                  ...
                  sliders: [
                    ...
                    SliderWidget(
                      label:
                          "Border Softness${borderMode ? ' (Classic only)' : ''}",
                    ...
                    SliderWidget(
                      label:
                          "One Side Light Intensity${borderMode ? ' (Classic only)' : ''}",
                    ...
                    SliderWidget(
                      label:
                          "Double Side Light Intensity${borderMode ? ' (Classic only)' : ''}",
                    ...
                    SliderWidget(
                      label:
                          "Border Saturation${!borderMode ? ' (Optical only)' : ''}",
                    ...
                    SliderWidget(
                      label:
                          "Ambient Intensity${!borderMode ? ' (Optical only)' : ''}",
                    ...
                    SliderWidget(
                      label:
                          "Border Solidity${!borderMode ? ' (Optical only)' : ''}",
                    ...
                    _ColorPickerRow(
                      label:
                          "Shadow Color${borderMode ? ' (Classic only)' : ''}",
